!function(a, b, c, d) {
    ...
    b = function() {
        ...
        var b, c, d = this;
        return c = d.options.centerMode === !0 ? d.slideWidth * Math.floor(d.options.slidesToShow / 2) : 0, 
        d.options.swipeToSlide === !0 ? (d.$slideTrack.find(".slick-slide").each(function(e, f) {
        ...
        var d = this;
        if ("boolean" == typeof a ? (b = a, a = b === !0 ? 0 : d.slideCount - 1) : a = b === !0 ? --a : a, 
        d.slideCount < 1 || a < 0 || a > d.slideCount - 1) return !1;
        d.unload(), c === !0 ? d.$slideTrack.children().remove() : d.$slideTrack.children(this.options.slide).eq(a).remove(), 
        ...
        if (b = b || !1, (j.animating !== !0 || j.options.waitForAnimate !== !0) && !(j.options.fade === !0 && j.currentSlide === a || j.slideCount <= j.options.slidesToShow)) {
            if (b === !1 && j.asNavFor(a), d = a, i = j.getLeft(d), g = j.getLeft(j.currentSlide), 
            j.currentLeft = null === j.swipeLeft ? g : j.swipeLeft, j.options.infinite === !1 && j.options.centerMode === !1 && (a < 0 || a > j.getDotCount() * j.options.slidesToScroll)) return void (j.options.fade === !1 && (d = j.currentSlide, 
            c !== !0 ? j.animateSlide(g, function() {
                j.postSlide(d);
            }) : j.postSlide(d)));
            if (j.options.infinite === !1 && j.options.centerMode === !0 && (a < 0 || a > j.slideCount - j.options.slidesToScroll)) return void (j.options.fade === !1 && (d = j.currentSlide, 
            c !== !0 ? j.animateSlide(g, function() {
                j.postSlide(d);
            }) : j.postSlide(d)));
            ...
            j.updateDots(), j.updateArrows(), j.options.fade === !0) return c !== !0 ? (j.fadeSlideOut(f), 
            ...
            return this.each(function() {
                function d(b) {
                    if (i) {
                        b = b || window.event;
                        var d = 0;
                        b.wheelDelta && (d = -b.wheelDelta / 120), b.detail && (d = b.detail / 3), a(b.target || b.srcTarget || b.srcElement).closest("." + c.wrapperClass).is(r.parent()) && e(d, !0), 
                ...
                function e(a, b, d) {
                    ...
                    b = Math.min(Math.max(b, 0), e), b = 0 < a ? Math.ceil(b) : Math.floor(b), u.css({
                        top: b + "px"
                    })), o = parseInt(u.css("top")) / (r.outerHeight() - u.outerHeight()), b = o * (r[0].scrollHeight - r.outerHeight()), 
                    d && (b = a, a = b / r[0].scrollHeight * r.outerHeight(), a = Math.min(Math.max(a, 0), e), 
                    u.css({
                        top: a + "px"
